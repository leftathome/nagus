...
func TestComparisonKey(t *testing.T) {
	for _, tc := range []struct {
		...
		{"vintage but the title says NV: a conflict, no key", "vintage", "", true, "", VintageStatusConflictNV},
		{"vintage, NV and a disgorgement year: still no key", "vintage", "2019", true, "", VintageStatusConflictNV},
