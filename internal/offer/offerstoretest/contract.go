...
func Run(t *testing.T, newStore NewStore) {
	...
	t.Run("RecordResolutionStamps", func(t *testing.T) { recordResolutionStamps(t, newStore(t)) })
	t.Run("ReingestSameHintPreservesResolution", func(t *testing.T) { reingestSameHintPreservesResolution(t, newStore(t)) })
	t.Run("ReingestChangedHintResets", func(t *testing.T) { reingestChangedHintResets(t, newStore(t)) })
	t.Run("RecordResolutionRefusesStaleHint", func(t *testing.T) { recordResolutionRefusesStaleHint(t, newStore(t)) })
	t.Run("RecordResolutionOnMissingOffer", func(t *testing.T) { recordResolutionOnMissingOffer(t, newStore(t)) })
	...
	t.Run("TextHintRoundTripsAndReopens", func(t *testing.T) { textHintRoundTripsAndReopens(t, newStore(t)) })
	t.Run("TextHintStaleAnswerIsDiscarded", func(t *testing.T) { textHintStaleAnswerIsDiscarded(t, newStore(t)) })
	t.Run("VintageModeRoundTripsAndResets", func(t *testing.T) { vintageModeRoundTripsAndResets(t, newStore(t)) })
